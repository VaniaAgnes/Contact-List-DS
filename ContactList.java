...
public class ContactList {
  ...
  public static Node searchEmail(DoubleLinkedList list, String email) {
  ...
  public static Node searchName(DoubleLinkedList list, String name) {
    Node current = list.getHead();
  ...
  public static void main(String[] args) {
    ...
    do {
      ...
      if (choice.equals("A")) {
        ...
        System.out.print("Delete contact (by name): ");
        ...
        Node node = searchEmail(list, email);
